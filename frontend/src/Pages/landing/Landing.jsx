...
export default function Landing() {
    return (
        <>
            ...
            <div className="landingContainerTop">
                    <div className="landingLeft">
                        <div className="leftbox">
                            <svg aria-hidden="true" className="leftboxIcon" width="80" height="70" viewBox="0 0 48 48" >
            ...
            <div className="landingContainerBottom">
